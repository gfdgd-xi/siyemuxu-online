 ...
 * ============================================================================
 *
 * Yanfly引擎是一个为PRG Maker MV制作的插件库，它是一个很棒的软件，可以用
 * 来帮你制作你自己梦想的游戏。你可以在这里找到很多关于RPG Maker MV的东西
 * 这个引擎插件的核心就是致力于处理游戏项目的核心方面，从提高游戏状态的限
 * 制到改变你窗口的颜色。同时通过这个插件，我们也会修复一些软件上的错误。
 * 只要有新的错误出现，这个插件会定期更新来修复
 * 
 * Yanfly引擎插件的核心对于插件库来说不是必须的 
 * 
 * Yanfly引擎插件的核心引擎是为RPG Maker MV制作的。这个插件的功能主要是修
 * 复错误和允许用户对于软件特性有更多的控制，例如屏幕显示，字体，窗口颜色
 * 等等。
 * 
 ...
 * ============================================================================
 *
 * 你可以使用这个插件命令来改变游戏内金钱9，999，999的上限。你也可以改变
 * 其他项目999，999的限制，例如物品，武器，装备等。 
 *
 * Plugin Command:
 ...
 * ============================================================================
 *
 * 可以改变一个玩家可以携带物品的最大数量。如果你希望每个物品有不同的最大
 * 值，你可以使用下面的标签。
 *
 * 物品，武器，装备标签:
 *   <Max Item: x>
 ...
 * ============================================================================
 *
 * 事件参数的限制的提升，我们可以对编辑器默认的限制操作。为了解除限制，我
 * 们可以使用下面的标签来获得对参数的更高控制权。
 *
 * 角色标签
 *   <Initial Level: x>
 ...
 *   <stat: +x>
 *   <stat: -x>
 *   这可以让武器或者装备能够失去或者获得某些状态。例如你可以替换stat状态为
 *   hp血量，mp蓝量，atk攻击，def防御，mat魔攻，mdf魔防，agi速度，luk幸运等
 *   。这将允许装备属性超过编辑器的默认值，只要符合最大允许范围
 *
 * 敌方标签
 *   <stat: x>
 *   这将改变敌方的状态。例如你可以替换stat状态为hp血量，mp蓝量，atk攻击，
 *   def防御，mat魔攻，mdf魔防，agi速度，luk幸运等。这将允许装备属性超过编
 *   辑器的默认值，只要符合最大允许范围
 *
 *   <exp: x>
 *   这将改变消灭敌方的经验值。它允许玩家得打超过编辑器默认9，999，999的更
 *   高经验值
 *
 * ============================================================================
